            ...
            <div class="card p-4">
                ...
                <form method="POST" class="row mb-3">
                    ...
                    <div class="col-4">
                        ...
                        <!-- Perbarui tombol cetak Anda -->
<button class="btn btn-primary w-100 mb-3" onclick="printData()">CETAK LAPORAN</button>

<script>
    function printData() {
        var divToPrint = document.getElementById("databarang");
        var newWin = window.open("");
        newWin.document.write('<html><head><title>Cetak Laporan</title>');
        newWin.document.write('<style>@media print { body { -webkit-print-color-adjust: exact; } table { border-collapse: collapse; } table, th, td { border: 1px solid black; padding: 8px; }</style>');
...
<!-- Tambahkan id pada tabel Anda -->
<div class="table-wrapper">
    <table id="databarang" class="table table-hover mt-3">
        <thead>
            <tr>
                <th>NO</th>
                <th>Kode Barang</th>
        ...
        <tbody>
            ...
            if (isset($_POST['bcari'])) {
                $keyword = $_POST['tcari'];
                $q = "SELECT * FROM tabel_masuk WHERE tanggalMasuk LIKE '%$keyword%' ORDER BY IdBarang DESC";
            } else {
